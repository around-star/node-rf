...
def train():
    ...
    load_dict = torch.load('/home/guests/hiran_sarkar/FullCode/DyNeRF-ODE_latent_dyn/logs_bouncing_balls/logs_bouncing_balls_n2f6_5k_200_interval_lat_train_dopri5_interp_kessel/bouncingballs/315000.tar')#["network_fine_state_dict"]
    ...
    colors = [colormap(i / (400-100)) for i in range(400-100)]
    ...
    plt.savefig('tsne_bb_4x_extrap_interp.png')
