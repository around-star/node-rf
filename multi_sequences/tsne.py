...
def train():
    ...
    load_dict = torch.load('/home/guests/hiran_sarkar/FullCode/DyNeRF-ODE_latent_dyn_var_position/logs/same_addnet_rk4_gen_layers3_dagobah0/pitcher_base/100000.tar')#["network_fine_state_dict"]
    ...
    angles = [[-0.4351, 0.6672, 0.10000000149011612]]
    ...
    for i in range(1):
        ...
        print(i)
        cmap = create_colormap(c[i], 1000)
        cmap2 = create_colormap(c[i+1], 1000)
        plt.scatter(tsne_result[i*500:(i+1)*500, 0], 
                    tsne_result[i*500:(i+1)*500, 1], 
                    label=f'Cluster {i}', color=np.concatenate((cmap[-500:-200],cmap2[-500:-300]), axis=0))
    ...
    plt.savefig('/home/guests/hiran_sarkar/FullCode/DyNeRF-ODE_latent_dyn_var_position/logs/same_addnet_rk4_gen_layers3_dagobah0_render/nODE_extrap_500_90k_ckpt2.png')
