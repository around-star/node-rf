...
def train():
    ...
    # angles = [[-0.04220002144575119, 0.5613999962806702, 0.5028529763221741],
    # [-0.08220002055168152, 0.5514000058174133, 0.5028529763221741],
    # [-0.11220000684261322, 0.5619999766349792, 0.5028529763221741],
    # [-0.15219999849796295, 0.5320000052452087, 0.5028529763221741],
    # [-0.022200018167495728, 0.571399986743927, 0.5028529763221741],
    # # [0.07779999077320099, 0.5220000147819519, 0.5028529763221741],
    # [0.017799988389015198, 0.5519999861717224, 0.5028529763221741],
    # [-0.002200024202466011, 0.5613999962806702, 0.5028529763221741]]
            

    times = torch.arange(0,25)/25
    time_obs = times[:1]
    time_to_pred = times
    ...
    # all_latents = pred_pose.cpu().detach().numpy()
    # all_latents = angle.cpu().detach().numpy()
    # print("Latent1: ", all_latents[-10:])
    # print("Latent2: ", all_latents[1][-10:])
    # print("Latent3: ", all_latents[2][-10:])
    # print("Latent4: ", all_latents[3][-10:])
    # print("Latent5: ", all_latents[4][-10:])
    # print("Latent6: ", all_latents[5][-10:])
    # print("Latent7: ", all_latents[6][-10:])
    ...
    print("All Latents: ", all_latents.shape)
    ...
    for result in tsne_result:
        ...
        plt.plot(result[:, 0], 
                        result[:, 1],
                        alpha=0.7)
        # plt.plot(result[half:, 0], 
        #                 result[half:, 1], 'o', color='red',
        #                 alpha=0.7)
    ...
    plt.savefig('tsne_hill_near_new_complete_loc_mlp_latent_node_addnet_euler_grad_align_80_ts/nODE_25_locs_extrap_25_div_col_s_10_ckpt_100_pose_encoded_GT.png')
